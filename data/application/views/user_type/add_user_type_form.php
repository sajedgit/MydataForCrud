			...
			<div class="panel-body">
				...
				?>
					...
					<div class='form-group'>
						...
						<input type='text' class='form-control'   name='user_type_name' placeholder='<?php echo $this->lang->line('user_type_user_type_name') ?>' >
...
<div class='form-group'>
						...
						<input type='text' class='form-control'   name='user_type_description' placeholder='<?php echo $this->lang->line('user_type_user_type_description') ?>' >
...
<div class='form-group'>
						...
						<input type='text' class='form-control'   name='user_type_active' placeholder='<?php echo $this->lang->line('user_type_user_type_active') ?>' >
