	...
	<div class="col-lg-12">
		<div class="table-responsive">
		   <table class="table">
			  ...
			  <tbody>
				 <tr>
					<td class='col-lg-3'><?php echo $this->lang->line('user_type_user_type_name') ?></td>
					<td class='col-lg-9'><?php echo $query_result->user_type_name;  ?></td>
				 </tr><tr>
					<td class='col-lg-3'><?php echo $this->lang->line('user_type_user_type_description') ?></td>
					<td class='col-lg-9'><?php echo $query_result->user_type_description;  ?></td>
				 </tr><tr>
					<td class='col-lg-3'><?php echo $this->lang->line('user_type_user_type_active') ?></td>
