	...
	<div class="col-lg-12">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				echo form_open("Message/create_message", $attributes);
				?>
					...
					<div class='form-group'>
						...
						<input type='text' class='form-control'   name='ref_message_message_type_id' placeholder='<?php echo $this->lang->line('message_ref_message_message_type_id') ?>' >
...
<div class='form-group'>
						...
						<input type='text' class='form-control'   name='message_title' placeholder='<?php echo $this->lang->line('message_message_title') ?>' >
						<span class='text-danger'><?php  echo form_error('message_title'); ?></span>
					</div>
<div class='form-group'>
						<label><?php echo $this->lang->line('message_message_details') ?></label>
						<input type='text' class='form-control'   name='message_details' placeholder='<?php echo $this->lang->line('message_message_details') ?>' >
...
<div class='form-group'>
						...
						<input type='text' class='form-control'   name='message_any_ending_date' placeholder='<?php echo $this->lang->line('message_message_any_ending_date') ?>' >
...
<div class='form-group'>
						...
						<input type='text' class='form-control'   name='message_ending_date' placeholder='<?php echo $this->lang->line('message_message_ending_date') ?>' >
...
<div class='form-group'>
						...
						<input type='text' class='form-control'   name='message_is_push_message' placeholder='<?php echo $this->lang->line('message_message_is_push_message') ?>' >
...
<div class='form-group'>
						...
						<input type='text' class='form-control'   name='message_created_by_admin_panel_login_id' placeholder='<?php echo $this->lang->line('message_message_created_by_admin_panel_login_id') ?>' >
...
<div class='form-group'>
						...
						<input type='text' class='form-control'   name='message_created_date_time' placeholder='<?php echo $this->lang->line('message_message_created_date_time') ?>' >
...
<div class='form-group'>
						...
						<input type='text' class='form-control'   name='message_edited_by_admin_panel_login_id' placeholder='<?php echo $this->lang->line('message_message_edited_by_admin_panel_login_id') ?>' >
...
<div class='form-group'>
						...
						<input type='text' class='form-control'   name='message_edited_date_time' placeholder='<?php echo $this->lang->line('message_message_edited_date_time') ?>' >
...
<div class='form-group'>
						...
						<input type='text' class='form-control'   name='message_send_now' placeholder='<?php echo $this->lang->line('message_message_send_now') ?>' >
...
<div class='form-group'>
						...
						<input type='text' class='form-control'   name='message_send_later_date_time' placeholder='<?php echo $this->lang->line('message_message_send_later_date_time') ?>' >
...
<div class='form-group'>
						...
						<input type='text' class='form-control'   name='message_is_already_sent' placeholder='<?php echo $this->lang->line('message_message_is_already_sent') ?>' >
...
<div class='form-group'>
						...
						<input type='text' class='form-control'   name='message_sending_date_time' placeholder='<?php echo $this->lang->line('message_message_sending_date_time') ?>' >
...
<div class='form-group'>
						...
						<input type='text' class='form-control'   name='message_active' placeholder='<?php echo $this->lang->line('message_message_active') ?>' >
